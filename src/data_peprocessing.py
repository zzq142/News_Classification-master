...
if __name__ == '__main__':
    # pre_train_txt = './data/train.txt'
    after_train_txt = './data/train_shuffle.txt'
    # pre_test_txt = './data/test.txt'
    after_test_txt = './data/test_shuffle.txt'
    ...
    # index = 0
    # with open('./data/test.txt',encoding='utf-8') as lines:
    #     for line in lines:
    #         #l= len(line.split('\t'))
    #         if '\ufeff' in line:
    #             print(index)
